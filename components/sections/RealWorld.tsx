        ...
        <Reveal>
          <SectionHeading
            ...
            title={
              <>
                AI{" "}
                <span className="gradient-text">matches who you are</span> to
                missions worth your time.
              </>
            }
            description="Six signal layers. One recommendation at a time."
            align="center"
          />
        </Reveal>
        ...
        <div className="mt-40">
          <Reveal>
            <div className="flex items-end justify-between gap-6 flex-wrap">
              <div>
                <p className="text-[11px] uppercase tracking-[0.2em] text-aurora-cyan">
                  Real-world missions
                </p>
                <h3 className="mt-3 font-serif text-4xl sm:text-5xl text-balance max-w-2xl">
                  Stop preparing for life.{" "}
                  <span className="italic text-white/60">Start living it.</span>
                </h3>
              </div>
              <p className="max-w-sm text-sm text-white/55 text-pretty">
                Short, vetted missions from startups, creators, and communities.
              </p>
            </div>
          </Reveal>
            ...
            {realWorldTiles.map((t, i) => (
              <Reveal key={t.title} delay={i * 0.06}>
                ...
                >
                  ...
                  <h4 className="mt-8 font-serif text-2xl text-balance">
                    {t.title}
                  </h4>
